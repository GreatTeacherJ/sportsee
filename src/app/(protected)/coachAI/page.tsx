					...
					<li className={styles.responseAi}>
						<div className={styles.messageContainer}>
							...
							<div className={styles.messageContent}>
								<p>
									Votre score de récupération indique à quel point votre
									corps a récupéré après vos précédents entraînements.
									<br />
									...
								</p>
							</div>
			...
			<section className={styles.prompt}>
				...
				<ul className={styles.tagContainer}>
					<li className={styles.tag}>
						<button type="button">Comment améliorer mon endurance ?</button>
					</li>
					<li className={styles.tag}>
						<button type="button">
